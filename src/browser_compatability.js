...
export function doesBrowserSupportWebComponents(){
...
export function loadWebComponentInto(tagname, replacedElements){
  ...
  console.log(replacedElements[0].id);
  logBrowserMessage(`replacing '${replacedElements[0].id}' with '${tagname}'`);
};